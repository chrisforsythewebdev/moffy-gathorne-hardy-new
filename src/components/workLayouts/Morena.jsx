      ...
      <div className="row justify-content-center">
        <div className="col-lg-8 col-md-10 col-sm-12 mx-auto text-start">
          ...
          <div className="mx-auto text-start" style={{ maxWidth: "700px", width: "100%" }}>
            ...
            <p>With the vague expectation of disappointment attendant on poetics of this kind, I boarded the plane, pyjamas and vodka orange, neck pillow, duty free lipstick — accoutrements to distract while leaping into the vast but familiar void — and all such good fun.</p>
            ...
            <p>Two days of night, the green of Hakone, the rushing of trains, spiders of kana and kanji, steam from an onsen like that of hot soup, Hanna — perceived in no order — and two me’s on their 23rd birthday, a mirror between them, waving across the universe, universe.</p>
                ...
                <p>But after all, there was work to be done, film to be shot, locations to be found; poetic musings were to be left behind, it was time to step into my body and take action. A departure had already been made — Hanna, and as a result, I having been commissioned to shoot this story — felt that we had been given the gift of an invitation to come up with something new.</p>

                <p>The witless and boring spiritual laziness of many powerful white male photographers taking pictures of lithe, vulnerable, naked nymphets now has an advocate in the self-professed intelligent and artistic; images of this kind now being passed off as ‘ironic’, or as ‘remarks’ on those that came before them, allowing for people to give free reign to their agendas of manipulation (and unoriginality) and dress it up as high art.</p>

                <p>The line between empowerment and disempowerment has become so blurred, the line between feminism and exploitation, that rehashed conversations about what it all means are now as mundane and hackneyed as the photographs themselves; but it is this interface that me and Hanna’s pictures inadvertently come into contact with.</p>

                <p>Indeed, social activism isn’t something that occurs to either of us when taking a photograph, we want to make something fun, visually interesting, maybe even beautiful, but which doesn’t take itself too seriously; However due to the vast discourse on sexualised imagery and exploitation of models that is occurring, whatever one creates necessarily becomes an addition to the discussion — and although we make no conscious effort to subvert these photographers or the photographs they take — it is a byproduct of the process.</p>

                <p>So it seems to me amusing that, considering our leanings towards mucking about and having a laugh, people may read this kind of meaning into the images, and in their attempt to find a moral behind them, take for social commentary pictures of me naked on the loo in a hotel room in Japan (imagine the possibilities for analysis !)</p>

                <p>What seems even more amusing is that at first glance the pictures could almost be the very thing we may seem to be subverting, could be taken by a white male photographer of a reticent young model, but are actually by a Korean lesbian of her cross eyed mate getting pissed on holiday, who, herself having a penchant for a bit of artistic porn — (or erotic art, depending on whether you’re explaining what you do to your grandma or someone you just met in the long and degrading queue for a Dazed and Confused party) — doesn’t need twice asking to get her kit off</p>
              
                <p>The idea, then, of these photographs being regarded in this light is both hilarious, and a solid testament to the idea that all imagery invites interpretation. What a wonderful joke to play on those who pontificate about the meaning behind things, who think they see what others cannot - because, in fact, it isn’t there — although remaining constant is the joke itself, which unspoken and barely even thought, is there between two people who are close to each other, and is a profound and lovely business of its own. Of course, if this is seen and enjoyed by the spectator, we welcome their addition to our club of two, and understand that there may be some unrecognised meaning, witnessed by the audience, that is integral despite our lack of awareness — and in which case, the joke is also on us.</p>
              
                <p>This is, after all, my area of expertise — having (again, accidentally) carved out a niche for myself as
                  nude model extraordinaire — whenever nakedness is required, my phone rings, and all because I’m
                  one of the very few who’s up for it. (I believe this is called winning by default !) The more
                  compromising the position the better, and just in case the fact of the subject (me) being quirky,
                  honest, and raw isn’t obvious enough for some viewers, perhaps a cigarette will be employed, or
                ...
                <p>
                  And then if I can use these photographs as some kind of reclaiming-my-own-body feminist
                  statement, then I am most certainly killing two birds with one stone; an unforeseen benefit of taking
                  your clothes off for money (which you might call Feminism for the Tarty and Lazy/ Challenging the
                  Patriarchy for Dummies... I’ll come up with something catchier later.)
                </p>
                ...
                <p>
                Indeed, a special kind of voyeurism is allowed for if the model and photographer are best friends,
and in between calling room service to take pictures of us in our halloween outfits rinsing the
minibar, I can be as revolting and as absurd as I am capable of, which is pure joy and freedom.
                </p>
            
                <p>
                However this is a different kind of freedom to the mental considerations that take place after the
fact, post-shoot, in the quiet of my own mind, following the unconscious acting out that took place,
where I attempt to make sense of what it actually means to photograph and be photographed.
                </p>
...
body. As, in its unparalleled creativity, the unconscious mind uses metaphor and symbolism in its
construction of dreams — (a falling tooth that evaporates in one’s grasp, a moment of nakedness in a
dusty classroom of the past) — so we find our template for the creation of art; the physical emblem
...
is viewing is of oneself.
                ...
                It was Sartre’s thesis that one becomes aware of oneself at the moment of becoming the object of the
‘Other’s’ regard; his famous example being the ‘Peeping Tom’, who hearing footsteps behind him as
he is caught at the keyhole, feels himself for the first time most agonizingly and essentially in his own
being. And as Tom — in this way, experiences himself, across the corridor — so one is both bought
close to and distanced from that slippery ‘I’ at the moment of confronting its photographic
representation. Indeed, in this moment, that old internal universe again comes into being, the
universe that one may attempt to traverse, but which can only end in the cyclical self of both subject
and object — I see myself, and I see myself, and I see myself too. Though while my own fears of
disembodiment are both quelled and reaffirmed, I am lucky with Hanna that I recognise my own
body, because both knowing and loving me, she does not attempt to distort it; both of us safe in the
assumption of the shared language that through the years of photographic narrative has developed
between us, a correspondence of looks that only love can transform the meaning of – the joy of
shorthand!
...
snake like, to insinuate itself into the consciousness of the viewer; it cannot be denied that our
experience of things beautiful or otherwise is rooted in sensory perception and is therefore a bodily
affair. Ultimately, then, despite a distaste for the corruption of the sublime by the literal, one cannot
bypass entirely the weighty and the actual, which despite their clumsiness, are comforting in that
they remind us of our humanity.
                </p>
...
mind of the other, forming a kind of holy trinity, a circle which is both whole and complete.
                ...
                expectation of this process of recollection and recognition in the act of consuming art, that we send
                an advanced party; projecting memories and ideas of our own onto that which resembles them in
                the work, and in return finding exactly what we were searching for in it. And in this ability of a piec
                of art to precipitate bodily sensations is one essential implication: that not only does the concrete
                external give rise to ideas abstract, but that these ideas can conversely influence the physical world
                — an invisible hand moving a glass across a table — two planes of existence interacting.
                </p>
                ...
                This way of seeing language can be applied also to photography. Just as the word allows for the
                world of the physical article and that of the internal representation to converge and form a third —
                independent of the first two — so the photograph distils life in such a way that the emergence of
                new realities is an inevitability, making of the photograph an object of undecided meaning. All
                interpretations of it, therefore, are left to the strange and beautiful workings of chance. And so,
                photographs do not profess to tell the future, and nor in their assumed finality, do they place limit
                on it; but instead invite infinite association, giving all things the potential of the Proustian
                Madeleine cake.
                </p>
              
              <p>
              A Korean and English girl — bought together in an intimacy which defies the distance they hav
              travelled to find each other — on the 36th floor of a strange hotel, while somewhere across Tokyo a 
              crab still moves in a bowl of ice; and a taste is recalled to the viewer of a piece of fruit they ate one
              summer, from the colour of a cherry red stocking draped over a chair in the background.
              </p>
