          ...
          <div>
            <p>
              ...
              present are distinct.
                ...
                <p>
                  Here is a Valley wherein <i>then</i> is a past made ever-present via its exhumation, all time pregnant with 
                  ...
                  which is not <i>now</i> — to use that word which pulls the rug from under one’s feet and leaves one 
                  breathless and grappling — and in other words, is closer in its condition to being <i>dead</i>.
                </p>
                ...
                <p>
                  ...
                  is a struggle against the impossibility of <i>getting outside</i> of a moment in time while existing in the 
                  ...
                  material evidence of lived experience and of memory, is to <i>fetishise</i> them. This fetishisation seems to 
                  presuppose a subject-object relation in our favour, archive passive and we active, but he suggests, as 
                  does Julia in her own way, that what occurs is the obverse of this coin: that we are <i>seduced</i> by the 
                  archive.
                </p>

                <p>
                  The ensuing fever, characterised as the insatiable, endlessly regressive reaching back in time, is 
                  addictive, compulsive, engendering a spiralling through and ultimately <i>past</i> information. Derrida 
                  ...
                  Speaking then of birth, death, burial and exhumation, this articulation of the <i>end point</i> of archival 
                  research (or of attempts at tracing a memory back to its genesis) as a <i>beginning</i> highlights the aporia 
